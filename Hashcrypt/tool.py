...
def main(**kwargs):
    """
    Hashcrypt- Instantly name the type of any hash!

    Inspired from the creator of RustScan and Ciphey.\n

    Example usage:\n
        python3 Hashcrypt --text -r -t '5f4dcc3b5aa765d61d8327deb882cf99'\n
        python3 Hashcrypt --file or -f hash\n
        python3 Hashcrypt --text '5f4dcc3b5aa765d61d8327deb882cf99' --greppable or -g\n
