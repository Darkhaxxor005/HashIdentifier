...
""")
	...
	if ver3 == 1:
		os.system("python3 Hashcrypt -t '" + ver1 + "' -v")
		input("\nPress Enter to continue") 
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 2:
		os.system("python3 Hashcrypt -t '" + ver1 + "' -g -v")
		input("\nPress Enter to continue")
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 3:
		os.system("python3 Hashcrypt -t '" + ver1 + "' -b64 -v")
		input("\nPress Enter to continue")
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 4:
		os.system("python3 Hashcrypt -t '" + ver1 + "' -a -v")
		input("\nPress Enter to continue")
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 5:
		os.system("python3 Hashcrypt -t '" + ver1 + "' -e -v")
		input("\nPress Enter to continue")
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 6:
		os.system("python3 Hashcrypt -t '" + ver1 + "' --no-john --no-banner -v")
		input("\nPress Enter to continue")
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 7:
		os.system("python3 Hashcrypt -t '" + ver1 + "' --no-hashcat --no-banner -v")
		input("\nPress Enter to continue")
		os.system("clear")
		os.system("python3 crypto.py")
	elif ver3 == 0:
